    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                ResultSet result = statement.executeQuery("SELECT emp_no, apellido, dept_no, salario FROM empleados WHERE dir = (SELECT emp_no FROM empleados WHERE apellido = 'REY') AND salario > (SELECT AVG(salario) FROM empleados e WHERE e.oficio = empleados.oficio)");
